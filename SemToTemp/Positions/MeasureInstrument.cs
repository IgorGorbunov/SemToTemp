...
class MeasureInstrument : Position
{
...
/// <param name="docYear">Год документа</param>
    public MeasureInstrument(string name, string title, GroupElement groupElement, Dictionary<string, string> parametrs, string doc, string docYear)
